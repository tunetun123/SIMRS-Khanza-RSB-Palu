    ...
    <div class="entry">
        <form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            <div style="width: 100%; height: 85%; overflow: auto;">
                        ...
                        if (($statuskirim == "Semua") || ($statuskirim == $statusdata)) {
                            ...
                            echo  "</td>
                                        <td valign='center' align='center'>
                                            ...
                                            <a href='?act=KlaimBaruManual2&action=Resume&norawat=" . $baris["no_rawat"] . "&tahunawal=$tahunawal&bulanawal=$bulanawal&tanggalawal=$tanggalawal&tahunakhir=$tahunakhir&bulanakhir=$bulanakhir&tanggalakhir=$tanggalakhir&codernik=$codernik&keyword=$keyword&carabayar=$carabayar&statuskirim=$statuskirim'>[Resume Dokter]</a><br>
                                            " . $status . "
                                        </td>                                
                                     </tr>";
                            $jumlah++;
                ...
                if (($action == "InputDiagnosa") || ($action == "InputCorona") || ($action == "RiwayatPerawatan") || ($action == "DataBilling") || ($action == "Resume")) {
