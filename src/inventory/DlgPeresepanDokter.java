...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
                ...
                if (aktifkanbatch.equals("yes")) {
                    ...
                    psresepasuransi = koneksi.prepareStatement(
                            "select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"
                                    ...
                                    + " and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and gudangbarang.kd_bangsal=? "
                                    +
                ...
                try {
                    ...
                    while (rsobat.next()) {
                        iyembuilder.append("{\"KodeBarang\":\"").append(rsobat.getString("kode_brng"))
                                .append("\",\"NamaBarang\":\"")
                                .append(rsobat.getString("nama_brng").replaceAll("\"", "")).append("\",\"Satuan\":\"")
                                .append(rsobat.getString("kode_sat")).append("\",\"Kandungan\":\"")
                                .append(rsobat.getString("letak_barang")).append("\",\"HargaKaryawan\":\"")
                                .append(Valid.roundUp(rsobat.getDouble("harga"), 100)).append("\",\"HargaRalan\":\"")
                                .append(Valid.roundUp(rsobat.getDouble("harga"), 100)).append("\",\"HargaBeliLuar\":\"")
                                .append(Valid.roundUp(rsobat.getDouble("harga"), 100)).append("\",\"HargaKelas1\":\"")
                                .append(Valid.roundUp(rsobat.getDouble("harga"), 100)).append("\",\"HargaKelas2\":\"")
                                .append(Valid.roundUp(rsobat.getDouble("harga"), 100)).append("\",\"HargaKelas3\":\"")
                                ...
                                .append(Valid.roundUp(rsobat.getDouble("harga"), 100)).append("\",\"HargaUtama\":\"")
                                .append(Valid.roundUp(rsobat.getDouble("harga"), 100)).append("\",\"Jenis\":\"")
                                .append(rsobat.getString("nama")).append("\",\"IndustriFarmasi\":\"")
                                ...
                                .append(rsobat.getDouble("kapasitas")).append("\"},");
                    }
                } catch (Exception e) {
                ...
                try {
                    ...
                    while (rsobat.next()) {
                        iyembuilder.append("{\"KodeBarang\":\"").append(rsobat.getString("kode_brng"))
                                ...
                                .append(rsobat.getString("kode_sat")).append("\",\"Kandungan\":\"")
                                .append(rsobat.getString("letak_barang")).append("\",\"HargaKaryawan\":\"")
                                .append(Valid.roundUp(rsobat.getDouble("karyawan"), 100)).append("\",\"HargaRalan\":\"")
                                .append(Valid.roundUp(rsobat.getDouble("ralan"), 100)).append("\",\"HargaBeliLuar\":\"")
                                .append(Valid.roundUp(rsobat.getDouble("beliluar"), 100))
                                .append("\",\"HargaKelas1\":\"").append(Valid.roundUp(rsobat.getDouble("kelas1"), 100))
                                .append("\",\"HargaKelas2\":\"").append(Valid.roundUp(rsobat.getDouble("kelas2"), 100))
                                .append("\",\"HargaKelas3\":\"").append(Valid.roundUp(rsobat.getDouble("kelas3"), 100))
                                .append("\",\"HargaVIP\":\"").append(Valid.roundUp(rsobat.getDouble("vip"), 100))
                                .append("\",\"HargaVVIP\":\"").append(Valid.roundUp(rsobat.getDouble("vvip"), 100))
                                .append("\",\"HargaUtama\":\"").append(Valid.roundUp(rsobat.getDouble("utama"), 100))
                                .append("\",\"Jenis\":\"").append(rsobat.getString("nama"))
                                .append("\",\"IndustriFarmasi\":\"").append(rsobat.getString("nama_industri"))
                                .append("\",\"HargaBeli\":\"").append(rsobat.getDouble("h_beli"))
                                .append("\",\"Stok\":\"").append(rsobat.getDouble("stok")).append("\",\"Kapasitas\":\"")
                                .append(rsobat.getDouble("kapasitas")).append("\"},");
                    }
                } catch (Exception e) {
                    System.out.println("Notifikasi : " + e);
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeResep.addRow(new Object[] {
                                    ...
                                    list.path("Jenis").asText(), list.path("IndustriFarmasi").asText(),
                        ...
                        for (JsonNode list : response) {
                            if (list.path("KodeBarang").asText().toLowerCase().contains(TCari.getText().toLowerCase())
                                    ...
                                    || list.path("Kandungan").asText().toLowerCase()
                                            .contains(TCari.getText().toLowerCase())) {
                                tabModeResep.addRow(new Object[] {
                                        false, "", "", list.path("KodeBarang").asText(),
                                        list.path("NamaBarang").asText(), list.path("Satuan").asText(),
                                        list.path("Kandungan").asText(),
                                        Double.parseDouble(list.path("HargaKaryawan").asText()),
                                        list.path("Jenis").asText(), list.path("IndustriFarmasi").asText(),
                                        Double.parseDouble(list.path("HargaBeli").asText()),
                                        Double.parseDouble(list.path("Stok").asText())
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeResep.addRow(new Object[] {
                                    false, "", "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                    Double.parseDouble(list.path("HargaVVIP").asText()), list.path("Jenis").asText(),
                                    list.path("IndustriFarmasi").asText(),
                                    Double.parseDouble(list.path("HargaBeli").asText()),
                                    Double.parseDouble(list.path("Stok").asText())
                            });
    ...
    public void emptTeksobat() {
        if (ChkRM.isSelected() == true) {
            ...
            // ifnull(MAX(CONVERT(RIGHT(resep_obat.no_resep,4),signed)),0) from resep_obat
            // where
            // resep_obat.tgl_peresepan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' or
            // resep_obat.tgl_perawatan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' ",
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeDetailResepRacikan.addRow(new Object[] {
                                    ...
                                    Double.parseDouble(list.path("Kapasitas").asText()), 1, "/", 1, "", 0,
